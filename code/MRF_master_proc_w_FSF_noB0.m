...
input_fat_sep_params.T2_fat_s_v = [80.1 54.7 54.7 51.9 51.9 46.2 50 44.1]/1000; % 7th entry not supplied, 50 ms is esimate
...
if exist('skiprecon','var') && skiprecon == 0
    ...
    % (also, gridded data needed for basis for matrix completion)
...
if doMRFAT == 1
    ...
    output_MRFAT = MRF_fat_sep_noB0( output_MRF_raw, output_img_recon, output_ksp_traj, output_dict, input_fat_sep_params );
